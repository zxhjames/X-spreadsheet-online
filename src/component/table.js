...
/** end */
//TODO:负责表格的渲染和绘制（核心类），一个table对象中调用render
class Table {
  constructor(el, data) {
    this.el = el;
  ...
  render() {
    ...
    // 1
    renderContentGrid.call(this, viewRange, fw, fh, tx, ty);//单元格的网格线，通过line绘制
    renderContent.call(this, viewRange, fw, fh, -x, -y);//data中的文本，通过
